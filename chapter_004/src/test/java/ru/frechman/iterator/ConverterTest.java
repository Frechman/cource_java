...
public class ConverterTest {
    ...
    @Test
    public void testHasNextWithEmptyIters() {
        Iterator<Integer> it0 = (new ArrayList<Integer>()).iterator();
        Iterator<Integer> it1 = Arrays.asList(7, 8, 9).iterator();
        Iterator<Integer> it2 = (new ArrayList<Integer>()).iterator();
        Iterator<Integer> it3 = Arrays.asList(7, 8, 9).iterator();
        Iterator<Integer> it4 = (new ArrayList<Integer>()).iterator();
        Iterator<Iterator<Integer>> its = Arrays.asList(it0, it1, it2, it3, it4).iterator();
        Converter iteratorOfIterators = new Converter();
        it = iteratorOfIterators.convert(its);
        assertThat(it.hasNext(), is(true));
        assertThat(it.next(), is(7));
